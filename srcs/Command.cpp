...
Command::Command(Server *server) : _server(server)
{
    ...
    FUNC f[] = {&Command::commandPASS, &Command::commandNICK,
                &Command::commandUSER, &Command::CommandPING,
                &Command::CommandPONG, &Command::CommandCAP,
                &Command::CommandJOIN, &Command::commandPRIVMSG,
                &Command::commandKICK, &Command::commandINVITE,
                &Command::commandMODE, &Command::commandWHO,
                &Command::commandQUIT, &Command::commandTOPIC,
                &Command::commandPART};
...
bool Command::nickIsCorrect(std::string buffer)
{
